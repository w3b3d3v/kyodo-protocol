...
interface IKyodoRegistry {
     ...
     */
    function createRegistry(string memory registry, address value, uint blockNumber) external;
     ...
     */
    function updateRegistry(string memory registry, address value, uint blockNumber) external;
